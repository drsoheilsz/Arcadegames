 ...
 */
update_option('myarcade_status', 1);
update_option('myarcade_hash', 'xxxxxxxxxx');
update_option('myarcade_pruef', 'myarcade');
update_option('myarcade_schluessel', true);
update_site_option('myarcade_status', 1);
update_site_option('myarcade_hash', 'xxxxxxxxxx');
update_site_option('myarcade_pruef', 'myarcade');
update_site_option('myarcade_schluessel', true);
