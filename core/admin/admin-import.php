...
function myarcade_import_games() {
	...
	$selected_method = filter_input( INPUT_POST, 'selectedmethod', FILTER_UNSAFE_RAW, array( 'options' => array( 'default' => 'importhtml5' ) ) );
	?>
					...
					<tr>
						<td>
							<select size="1" name="importmethod" id="importmethod">
								<option value="importhtml5" <?php selected( 'importhtml5', $selected_method ); ?>><?php esc_html_e( 'HTML5 game (.zip)', 'myarcadeplugin' ); ?>&nbsp;</option>
								...
								<option value="importibparcade" <?php selected( 'importibparcade', $selected_method ); ?>><?php esc_html_e( 'IBPArcade game (.tar)', 'myarcadeplugin' ); ?></option>
								<option value="importphpbb" <?php selected( 'importphpbb', $selected_method ); ?>><?php esc_html_e( 'PHPBB game (.zip)', 'myarcadeplugin' ); ?></option>
								<option value="importunity" <?php selected( 'importunity', $selected_method ); ?>><?php esc_html_e( 'Unity3D game (.unity3d)', 'myarcadeplugin' ); ?></option>
